/**
 * Autocorrection pipeline for hashline edit replacement lines.
 *
 * Fixes common LLM mistakes: rewrapped lines, merged single lines,
 * and lost indentation.
 */
...
/** Collapse LLM-rewrapped multi-line spans back to originals. */
...
/** Split a merged single-line back into the original line count. */
export function maybeExpandSingleLineMerge(originalLines: string[], replacementLines: string[]): string[] {
...
/** Restore indentation from original lines when line counts match. */
export function restoreIndentForPairedReplacement(originalLines: string[], replacementLines: string[]): string[] {
...
/** Pipeline: expand merges, restore wraps, restore indentation. */
export function autocorrectReplacementLines(originalLines: string[], replacementLines: string[]): string[] {
