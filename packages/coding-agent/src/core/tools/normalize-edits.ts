 ...
 *
 * Maps raw edit shapes to the canonical HashlineEdit union types,
 * validating required fields per operation.
 */
...
/**
 * Normalize an array of raw edit objects into typed HashlineEdit objects.
 * Validates required fields and rejects unknown operation types.
 */
